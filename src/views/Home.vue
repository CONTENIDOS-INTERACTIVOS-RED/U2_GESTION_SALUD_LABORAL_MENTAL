        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad “Medicina Preventiva y del Trabajo en Colombia” aborda la importancia de la salud ocupacional desde un enfoque legal, preventivo y estratégico. Se destacan tres ejes: el marco normativo colombiano, estrategias preventivas ante riesgos laborales (ergonomía, factores ambientales, evaluaciones médicas), y diseño de programas preventivos (vacunación, educación, nutrición, ECNT). El contenido resalta la evolución histórica de la legislación, su aplicación práctica y los beneficios en productividad, salud mental y bienestar. Promueve una cultura organizacional preventiva y resiliente, fortaleciendo el talento humano y el desarrollo sostenible empresarial.
